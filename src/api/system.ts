...
export const login = (data: any) => request.post<any>({ url: '/system/admin/login', method: 'post', data }, { show: true })
export const logout = () => request.post({ url: '/system/admin/logout', method: 'post' }, { show: true, message: allMsgs.logout })
