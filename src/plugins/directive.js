...
function onLoadTableScrollY(app) {
  ...
  app.directive('loading', {
    mounted(el, binding) {
      if (binding.value) {
        ...
        // 复制
        const loadingDivCopy = loadingDiv.cloneNode(true)
...
export default function onLoadDirective(app) {
  onLoadAuth(app)
