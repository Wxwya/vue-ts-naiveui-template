      ...
      <n-form :model="info">
        ...
        <n-form-item path="password" label="密码:">
          <n-input v-model:value="info.password" :type="type" placeholder="请输入密码">
            ...
            <template #suffix>
              <span
                :class="`iconify cursor-pointer text-xl ${type === 'password' ? 'solar--lock-password-bold-duotone' : 'solar--lock-password-unlocked-bold-duotone'}`"
                @click="type === 'password' ? type = 'text' : type = 'password'"></span>
            </template>
          </n-input>
        </n-form-item>
